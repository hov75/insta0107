...
import './Profile.css'
import { deletePost as deletePostPosts } from '../../store/slices/posts/postsSlice';
import { deletePost as deletePostUser } from '../../store/slices/users/usersSlice';
const Profile = () => {
            ...
            currentUser?.posts.map(el => (
                <div key={el.id} className="gallery-item">
                    ...
                    <div className="gallery-item-info">
                        <span onClick={() => {dispatch(deletePostPosts(el.id), dispatch(deletePostUser(el.id)))}} className='deletPost'>X</span>
                        <ul>
